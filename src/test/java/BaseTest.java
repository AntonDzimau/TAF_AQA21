 ...
 * expectedExceptions - тест ищет определенный эксэпш, если при выполнении кода эксепшн нашел, тест положительный
 * если не нашел - тест отрицательный
 * expectedExceptions = {DigestException.class, NullPointerException.class} - перечисление
 * нескольких искомых эксепшенов
 */