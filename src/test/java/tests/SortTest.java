...
public class SortTest extends BaseTest {
    ...
    public void sortByAZTest() {
        ...
        sortStep
                .setSortByAlphabet("az")
                .getFirstItemByName()
                .shouldHave(Condition.text("Sauce Labs Backpack"));
    }
    ...
    public void sortByZATest() {
        loginStep
                .loginSuccessful(ReadProperties.usernameStandard(), ReadProperties.password());
        sortStep
                .setSortByAlphabet("za")
                .getFirstItemByName()
                .shouldHave(Condition.text("Test.allTheThings() T-Shirt (Red)"));
    }
    ...
    public void sortByPriceLowToHighTest() {
        ...
        sortStep
                .setSortByPrice("lohi")
                .getFirstItemByPrice()
                .shouldHave(Condition.text("$7.99"));
    }
    ...
    public void sortByPriceHighToLowTest() {
        ...
        sortStep
                .setSortByPrice("hilo")
                .getFirstItemByPrice()
                .shouldHave(Condition.text("$49.99"));
    }
}
